...
import uz.gigalab.shop.domain.Employee;
import uz.gigalab.shop.repository.EmployeeRepository;
...
/**
 * REST controller for managing {@link uz.gigalab.shop.domain.Employee}.
 */
@RestController
@RequestMapping("/api")
@Transactional
